...
# MAGIC 
# MAGIC Optimizing ML performance from a jobs and cluster perspective is a critical part of ML Performance. Steps to tease apart ML performance will often use a variety of methods listed in the table below.
# MAGIC 
