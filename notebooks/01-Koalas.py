...
# MAGIC %md
# MAGIC ## Exercise 2:
# MAGIC Let's build a plot that uses the retail data from **Exercise 1** to look at number of products sold per season. Please use Koalas to do the following:
